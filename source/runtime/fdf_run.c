...
/*   Updated: 2019/07/21 17:26:14 by viwade           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
#define K_SC2(k,s,r)	IF_C(r=k[KEY_NUM_MINUS],K_SCLZ(s,(1/1.125)))
#define K_SC1(k,s,r)	IF_E(r=k[KEY_NUM_PLUS],K_SCLZ(s,(1.125)),K_SC2(k,s,r))
#define K_SC0(s)	 	IF_C(s.z!=S_Z0,s.z=S_Z0;return(1))
#define K_SCL(k,s,r)	IF_C(r=k[KEY_0],K_SC0(s);K_SC1(k,s,r))
